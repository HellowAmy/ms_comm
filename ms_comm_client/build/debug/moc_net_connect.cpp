...
QT_MOC_LITERAL(7, 60, 3), // "txt"
QT_MOC_LITERAL(8, 64, 13), // "fa_swap_files"
QT_MOC_LITERAL(9, 78, 8) // "filename"

    },
    "net_connect\0fa_login_status\0emit\0ok\0"
    "fa_swap_txt\0from\0string\0txt\0fa_swap_files\0"
    "filename"
};
...
static const uint qt_meta_data_net_connect[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::LongLong, 0x80000000 | 6,    5,    9,
...
void net_connect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->fa_swap_txt((*reinterpret_cast< long long(*)>(_a[1])),(*reinterpret_cast< string(*)>(_a[2]))); break;
        case 2: _t->fa_swap_files((*reinterpret_cast< long long(*)>(_a[1])),(*reinterpret_cast< string(*)>(_a[2]))); break;
        default: ;
        }
...
// SIGNAL 2
void net_connect::fa_swap_files(long long _t1, string _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
